 ...
 */
public class PaymentCodePool  implements IPayCodePool {


    private static final Logger log = Logger.getLogger(PaymentCodePool.class.getSimpleName());
    ...
    */
    ...
    @Override
    public Integer getPayCodeFromPool() {
    ...
    public static class SetAvailableNumsBack extends TimerTask {
        ...
        private static final Logger logTask = Logger.getLogger(PaymentCodePool.class.getSimpleName());
